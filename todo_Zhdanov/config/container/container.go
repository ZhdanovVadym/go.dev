...
func (db *dummyDB) Insert(task *Task) error {

	return nil
}

func (db *dummyDB) Get(task *Task, id int) error {

	return nil
}

func (db *dummyDB) Update(task *Task) error {

	return nil
}

func (db *dummyDB) Delete(id int) error {
